            ...
            <div className='flex'>
                <div className='w-full md:w-1/2 flex flex-col justify-center items-center p-5 md:p-10'>
                    <form onSubmit={handleSubmit} className="w-full max-w-md bg-white p-5 rounded-lg border shadow-sm ">
                        ...
                        <h2 className='tect-2xl font-bold text-center mb-3'>Hey there!</h2>
                        <p className='text-center mb-6'>Enter your name password to Login.</p>
                        <div className='mb-4'>
                ...
                <div className='hidden md:block w-1/2 bg-gray-800'>
                    <div className='h-full flex flex-col justify-center items-center'>
                        <img src={SignUp} alt="Login to Account"
